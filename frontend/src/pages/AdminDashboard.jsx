...
import {
    ...
    ShoppingBag, CheckCircle, AlertCircle, LogOut, ChevronRight, CreditCard, MessageSquare, MessageCircle
} from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    const cards = [
        ...
        { title: 'Reviews',            icon: MessageSquare,   path: '/admin/reviews',         color: '#f59e0b', bg: '#fffbeb', desc: 'Moderate customer reviews' },
        { title: 'Support Inbox',      icon: MessageCircle,   path: '/admin/support',         color: '#0ea5e9', bg: '#f0f9ff', desc: 'Answer customer tickets' },
    ];
